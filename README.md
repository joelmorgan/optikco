...
## Notes / next steps
- The hero background and the 4 circular icons are CSS-only placeholders (the Figma source images couldn't be fetched from this environment). Drop real images into an `/images` folder and swap them into `index.html` / `styles.css` whenever you're ready — everything else matches the design.
